...
# Kleaf LLVM fix: CROSS_COMPILE=llvm- breaks the legacy regex above,
# leaving HOST_ARCH unset and triggering a fatal #error in efi_helper.c.
# Fallback to the known ARCH variable if regex detection failed.
ifeq ($(HOST_ARCH),)
  ifeq ($(ARCH),x86)
    export HOST_ARCH=$(HOST_ARCH_X86_64)
